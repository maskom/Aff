...
| AFF-02 | Modularize landing components | Phase 1 | Frontend | 5d | Done | `app.vue` refactored into components under `components/affiliate/`. Unit tests pending (AFF-01 CI setup). |
