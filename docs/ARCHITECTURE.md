...
- Validate all environment variables in Nuxt runtime config before bootstrapping using zod schema validation (implemented in Phase 1 Task 4 via `lib/config/runtime-config.ts`).
