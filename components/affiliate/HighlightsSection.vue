<template>
  <section class="highlights-section">
    <div class="highlights-section__badge">Tips Hari Ini</div>
    <h1 class="highlights-section__title">Optimalkan penawaran terbaikmu</h1>
    <p class="highlights-section__text">
      Gunakan materi promosi siap pakai, atur ulang CTA sesuai audiens, dan pantau
      performa konversi untuk memaksimalkan komisi.
    </p>
    <button class="highlights-section__action" type="button">Lihat Toolkit</button>
  </section>
</template>
